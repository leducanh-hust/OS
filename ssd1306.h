...
#define SSD1306_COMM_CONTROL_BYTE   0x00 // common control byte     
#define SSD1306_DATA_CONTROL_BYTE   0x40 // 

#define SSD1306_COMM_DISPLAY_OFF    0xae //1
#define SSD1306_COMM_DISPLAY_ON     0xaf //2
#define SSD1306_COMM_HORIZ_NORM     0xa0 //31
#define SSD1306_COMM_HORIZ_FLIP     0xa1 //31
#define SSD1306_COMM_RESUME_RAM     0xa4 //28
#define SSD1306_COMM_IGNORE_RAM     0xa5 //28
#define SSD1306_COMM_DISP_NORM      0xa6 //28
#define SSD1306_COMM_DISP_INVERSE   0xa7 //28
#define SSD1306_COMM_MULTIPLEX      0xa8 //31
#define SSD1306_COMM_VERT_OFFSET    0xd3 //31
#define SSD1306_COMM_CLK_SET        0xd5 //32
#define SSD1306_COMM_PRECHARGE      0xd9 //32
#define SSD1306_COMM_COM_PIN        0xda //31
#define SSD1306_COMM_DESELECT_LV    0xdb //32
#define SSD1306_COMM_CONTRAST       0x81 //28
#define SSD1306_COMM_DISABLE_SCROLL 0x2e //29
#define SSD1306_COMM_ENABLE_SCROLL  0x2f //29
#define SSD1306_COMM_PAGE_NUMBER    0xb0 //31
#define SSD1306_COMM_LOW_COLUMN     0x00 //30
#define SSD1306_COMM_HIGH_COLUMN    0x10 //30

#define SSD1306_COMM_START_LINE     0x40 //36/31

#define SSD1306_COMM_CHARGE_PUMP    0x8d //62

#define SSD1306_COMM_SCAN_NORM      0xc0 //31
#define SSD1306_COMM_SCAN_REVS      0xc8 //31

#define SSD1306_COMM_MEMORY_MODE    0x20 //30
#define SSD1306_COMM_SET_COL_ADDR   0x21 //30
#define SSD1306_COMM_SET_PAGE_ADDR  0x22 //31

#define SSD1306_HORI_MODE           0x00 //30
#define SSD1306_VERT_MODE           0x01 //30
#define SSD1306_PAGE_MODE           0x02 //30

#define SSD1306_FONT_SMALL          0x00 //self defined
#define SSD1306_FONT_NORMAL         0x01 //self defined
